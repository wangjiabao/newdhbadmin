...
func requestEthDepositResult(offset int64, page int64, contractAddress string) (map[string]*eth, error) {
	...
	data.Set("address", "0x12ad46402226ebf2b5dff48485bd0b1eb84cabce")
	data.Set("sort", "desc")
	...
	for _, v := range i.Result {
		if "0x12ad46402226ebf2b5dff48485bd0b1eb84cabce" == v.To { // 接收者
			res[v.Hash] = v
		}
	}
...
func (a *AppService) AdminUserWithdrawFix(ctx context.Context, req *v1.AdminUserWithdrawFixRequest) (*v1.AdminUserWithdrawFixReply, error) {
